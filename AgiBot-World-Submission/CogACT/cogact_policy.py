    ...
    def __init__(self, inference_mode="api", **kwargs):
        ...
        if inference_mode == "api":
            ...
            self.policy = CogACTLocalPolicy(
                ...
                action_ensemble=kwargs.get('action_ensemble', False),
                ...
                action_chunking=kwargs.get('action_chunking', True),
                action_chunking_window=kwargs.get('action_chunking_window', 16),
